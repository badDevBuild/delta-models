...
- `public/game-guides.json`：每款模型的「优点、怎么打、带什么子弹」简短说明，含地区、玩法、核对日期和资料链接。
...
每次切换释放上一模型的几何、材质与纹理，过期请求不能覆盖当前选中展品。颜色直接使用导出材质，不统一压黑木质或绿色外观。玩法提示的判断与资料来源分开记录，未经核对的国服数值不写作已确认事实。
